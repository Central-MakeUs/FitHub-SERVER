...
public class UserConverter {
    ...
    public static User toSocialUser(UserRequestDto.UserOAuthInfo request, User user) throws IOException
    {
        ...
        if((request.getGender() == ""|| request.getGender() == null || request.getBirth() == ""|| request.getBirth() == null || request.getName() == "" || request.getName() == null || request.getName().equals("임시 이름") || request.getBirth().equals("123456"))){
    ...
    public static User toCompleteUser(User user, ExerciseCategory exerciseCategory){
        UserExercise mainExercise = staticUserExerciseRepository.findAllByUserAndExerciseCategory(user, exerciseCategory).get(0);
