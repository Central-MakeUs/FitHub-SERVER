...
public class RecordRestController {
    ...
    public ResponseDto<RecordResponseDto.recordDtoList> recordTimeList(@RequestParam(name = "pageIndex",required = false) Integer pageIndex, @PathVariable(name = "categoryId") @ExistCategory Integer categoryId, @AuthUser User user){
